...
import { createLaunchConfigFromContext } from './valdiDebugConfigurationResolver';
...
@injectable()
export class ValdiInitialDebugConfigurationProvider extends BaseConfigurationProvider<
  AnyValdiConfiguration
> {
...
type DynamicConfig = ResolvingValdiConfiguration | ResolvingTerminalConfiguration;

const keysToRelativize: ReadonlyArray<string> = ['cwd', 'program'];

@injectable()
export class ValdiDynamicDebugConfigurationProvider extends BaseConfigurationProvider<
  AnyValdiConfiguration | AnyTerminalConfiguration
> {
