...
export interface IValdiLaunchConfiguration extends INodeBaseConfiguration, IConfigurationWithEnv {
  type: DebugType.SnapValdi;
  request: 'launch';
 ...
 * Configuration for an attach request.
 */
export interface IValdiAttachConfiguration extends INodeBaseConfiguration {
  type: DebugType.SnapValdi;
  request: 'attach';
  ...
  /**
   * If set to true, kill the session when the first attached target dies.
   */
  dieWithTarget?: boolean;
}
...
export type AnyValdiConfiguration = IValdiAttachConfiguration | IValdiLaunchConfiguration;
...
export type AnyLaunchConfiguration = AnyChromiumConfiguration | AnyNodeConfiguration | AnyValdiConfiguration;
...
export type ResolvingValdiAttachConfiguration = ResolvingConfiguration<IValdiAttachConfiguration>;
export type ResolvingValdiLaunchConfiguration = ResolvingConfiguration<IValdiLaunchConfiguration>;
...
export type ResolvingValdiConfiguration = ResolvingValdiAttachConfiguration | ResolvingValdiLaunchConfiguration;
...
export type AnyResolvingConfiguration =
  ...
  | ResolvingNodeAttachConfiguration
  | ResolvingValdiAttachConfiguration
  | ResolvingNodeLaunchConfiguration
...
export const valdiAttachConfigDefaults: IValdiAttachConfiguration = {
  ...nodeBaseDefaults,
  type: DebugType.SnapValdi,
  attachExistingChildren: true,
  address: 'localhost',
...
export function applyValdiDefaults(config: ResolvingValdiConfiguration): AnyValdiConfiguration {
  if (config.request !== 'attach') {
    throw new Error('Valdi targets only support \'attach\'');
  }
  const filled = { ...valdiAttachConfigDefaults, ...config };
...
export function applyDefaults(config: AnyResolvingConfiguration): AnyLaunchConfiguration {
  ...
  switch (config.type) {
    ...
    case DebugType.Terminal:
      ...
      break;
    case DebugType.SnapValdi:
      configWithDefaults = applyValdiDefaults(config);
      break;
    default:
