...
export const enum Commands {
  ...
  AutoAttachSetVariables = 'extension.NAMESPACE(js-debug).setAutoAttachVariables',
  AutoAttachClearVariables = 'extension.NAMESPACE(js-debug).clearAutoAttachVariables',
  AutoAttachToProcess = 'extension.NAMESPACE(js-debug).autoAttachToProcess',
  ...
  EnlistExperiment = 'extension.NAMESPACE(js-debug).experimentEnlist',
  ...
  RevealPage = 'extension.NAMESPACE(js-debug).revealPage',
...
export function shouldRegisterDebugAdapterDescriptorFactory(debugType: DebugType): boolean {
  return debugType === DebugType.SnapValdi
}
