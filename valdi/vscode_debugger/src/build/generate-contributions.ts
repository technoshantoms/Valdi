...
const valdiAttachConfig: IDebugger<IValdiAttachConfiguration> = {
  ...nodeAttachConfig,
  type: DebugType.SnapValdi,
  defaults: valdiAttachConfigDefaults,
  configurationSnippets: [],
  configurationAttributes: {
    ...
    dieWithTarget: {
      ...
      markdownDescription: 'If set to true, kill the session when the first attached target dies.' as any,
      default: true,
    },
  }
};
...
if (require.main === module) {
  process.stdout.write(
    JSON.stringify({
      ...
      contributes: {
        // // TODO: We can register our own custom menus here
        // menus,
        breakpoints: breakpointLanguages.map(language => ({ language })),
        debuggers: buildDebuggers(),
        // // TODO: We can register our own custom commands here
        // commands,
        // // TODO: We can register our own custom extension config
        // configuration: {
        //   title: 'Valdi JS Debugger',
