...
private:
  ...
  static constexpr size_t didUseCustomMeasureIdx = 4;
  facebook::yoga::Bitfield<uint8_t, YGDirection, bool, bool, bool, bool> flags_ =
      {YGDirectionInherit, false, false, false, false};
...
public:
  ...
  decltype(flags_)::Ref<hadOverflowIdx> hadOverflow() {
    ...
    bool didUseCustomMeasure() const { return flags_.at<didUseCustomMeasureIdx>(); }
    decltype(flags_)::Ref<didUseCustomMeasureIdx> didUseCustomMeasure() {
      return flags_.at<didUseCustomMeasureIdx>();
    }
