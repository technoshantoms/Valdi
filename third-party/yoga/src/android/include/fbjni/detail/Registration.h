...
// TODO(APP-48620)
// The critical native registration flow is disabled here.
// This doesn't seem to work on Chromebook. It might be
// because we are not shipping an x86 version of libclient.
// We should revisit this again if we do end up shipping
// an x86 version.
