...
#define FB_JNI_TRY try
#define FB_JNI_CATCH(__catch_block__) catch __catch_block__
#define FB_JNI_THROW throw
#else
#define FB_JNI_TRY
#define FB_JNI_CATCH(__catch_block__) if (false)
#define FB_JNI_THROW std::abort();
#endif
