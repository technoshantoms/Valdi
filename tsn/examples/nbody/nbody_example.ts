...
function printValues(str : string) {
    console.log(str)
    console.log(energy().toFixed(9));
    console.log("Sun Array", bodies[0]);
    console.log("Jupiter Array", bodies[1]);
    console.log("Saturn Array", bodies[2]);
    console.log("Uranus Array", bodies[3]);
    console.log("Neptune Array", bodies[4]);
}
